        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <p className="text-sm text-gray-600 leading-relaxed">
              Open Budget: Sacramento is an open-source project by{' '}
              <a
              ...
              that seeks to help residents understand Sacramento&apos;s spending and budget process better. This application is a clone of{' '}
              <a
          ...
          <div className="md:text-right">
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/who-we-are" className="text-gray-600 hover:text-gray-900">
                  About the Project
                </Link>
              </li>
              <li>
